...
`)},M1=(e,t=!0)=>a=>(t&&V1(e),a.env.isDebug&&r.info("Options:",e),$(a,{id:"hope"}),{name:L,define:E1(e,t),extendsBundlerOptions:(o,i)=>{e?.components?.includes("VidStack")&&G(o,i,/^media-/),J(o,i,"vuepress-shared")},clientConfigFile:o=>O1(o,e,t)});export{V as AVAILABLE_SERVICES,u as SHARE_CONFIG,B as backToTopLocales,M1 as componentsPlugin,E as pdfLocaleConfig,O as siteInfoLocaleConfig};
