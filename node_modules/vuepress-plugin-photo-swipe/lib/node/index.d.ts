...
declare const photoSwipePlugin: (options?: PhotoSwipeOptions, legacy?: boolean) => PluginFunction;

export { type PhotoSwipeLocaleConfig, type PhotoSwipeLocaleData, type PhotoSwipeOptions, photoSwipeLocales, photoSwipePlugin };
