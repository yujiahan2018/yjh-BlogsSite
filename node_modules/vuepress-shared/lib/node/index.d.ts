...
import { PageFrontmatter, LocaleData, LocaleConfig } from 'vuepress/shared';
 ...
 */
declare const getLocales: <T extends LocaleData>({ app, name, default: defaultLocalesConfig, config: userLocalesConfig, }: GetLocalesOptions<T>) => RequiredLocaleConfig<T>;
