...
import { VPLink, isLinkHttp, isLinkWithProtocol, keys, startsWith, } from "vuepress-shared/client";
...
export default defineComponent({
    ...
    setup(props, { attrs, emit, slots }) {
        ...
        const renderVPLink = computed(() => !isHttp.value && !withProtocol.value && !isBlankTarget.value);
        // resolve the `rel` attr
        const anchorRel = computed(() => config.value.rel ||
