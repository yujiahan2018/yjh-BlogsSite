 ...
 */
const resolveFromFrontmatterConfig = (router, conf) => {
    if (conf === false)
        return false;
    if (isString(conf))
...
export default defineComponent({
    ...
    setup() {
        ...
        const prevNavLink = computed(() => {
            const prevConfig = resolveFromFrontmatterConfig(router, frontmatter.value.prev);
        ...
        const nextNavLink = computed(() => {
            const nextConfig = resolveFromFrontmatterConfig(router, frontmatter.value.next);
