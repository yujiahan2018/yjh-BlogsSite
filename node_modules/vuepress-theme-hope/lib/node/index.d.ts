...
import { RedirectOptions } from 'vuepress-plugin-redirect';
...
interface BlogPluginOptions extends Partial<Pick<BlogOptions, "excerptFilter" | "excerptLength" | "excerptSeparator" | "filter" | "slugify" | "hotReload">> {
    /**
...
interface PluginsOptions {
     ...
     */
    mdEnhance?: (Omit<MarkdownEnhanceOptions, "hint"> & {
        /**
 ...
 */
declare const getAutoCatalogPlugin: (autoCatalog?: AutoCatalogOptions | boolean, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getCopyCodePlugin: (options?: CopyCodeOptions | boolean, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getCopyrightPlugin: (themeData: ThemeData, options?: Partial<CopyrightOptions> | boolean, hostname?: string, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getFeedPlugin: (themeData: ThemeData, options?: Omit<FeedOptions, "hostname"> | boolean, hostname?: string, favicon?: string, legacy?: boolean) => Plugin | null;
 ...
 */
declare const getPhotoSwipePlugin: (options?: PhotoSwipeOptions | boolean, legacy?: boolean) => Plugin | null;
 ...
 */
declare const usePlugin: (app: App, themeData: ThemeData, plugins: PluginsOptions, hotReload: boolean, behavior: HopeThemeBehaviorOptions, legacy?: boolean) => void;
...
export { type AppearanceConfig, type AppearanceLocaleData, type AppearanceOptions, type ArticleInfo, ArticleInfoType, type AutoLinkOptions, type BlogLocaleConfig, type BlogLocaleData, type BlogLocaleOptions, type BlogPluginOptions, type DarkmodeOptions, type DirInfo, type DocsRepoLocaleOptions, type EncryptConfig, type EncryptLocaleData, type EncryptOptions, type FeatureConfig, type FeatureLocaleConfig, type FeatureLocaleData, type FeatureLocaleOptions, type FeatureOptions, type FileInfo, type FooterLocaleOptions, type HopeThemeBehaviorOptions, type InfoOptions, type LayoutLocaleConfig, type LayoutLocaleData, type LayoutLocaleOptions, type LayoutOptions, type MetaLocaleOptions, type MetaLocateData, type NavGroup, type NavbarComponent, type NavbarGroup, type NavbarItem, type NavbarLayoutOptions, type NavbarLocaleData, type NavbarLocaleOptions, type NavbarOptions, type OutlookLocaleData, type PageInfo, PageType, type PaginationLocaleData, type PluginsOptions, type PrismjsDarkTheme, type PrismjsLightTheme, type PrismjsOptions, type PrismjsTheme, type RouteLocaleData, type SidebarArrayOptions, type SidebarDirInfo, type SidebarFileInfo, type SidebarGroupItem, type SidebarInfo, type SidebarItem, type SidebarLocaleOptions, type SidebarObjectOptions, type SidebarOptions, type SidebarPageItem, type SidebarSorter, type SidebarSorterFunction, type SidebarSorterKeyword, type SidebarStructureItem, type StructureInfo, type TextItemOptions, type ThemeBlogHomePageFrontmatter, type ThemeBlogHomeProjectOptions, type ThemeBlogPluginHelper, type ThemeCommentPluginHelper, type ThemeCopyCodePluginHelper, type ThemeCopyrightPluginHelper, type ThemeData, type ThemeFeedPluginHelper, type ThemeGitPluginHelper, type ThemeHopePageFrontmatter, type ThemeLocaleConfig, type ThemeLocaleData, type ThemeLocaleOptions, type ThemeMdEnhancePluginHelper, type ThemeNavbarHelper, type ThemeNormalPageFrontmatter, type ThemeOptions, type ThemePWAPluginHelper, type ThemePageData, type ThemePageFrontmatter, type ThemePhotoSwipePluginHelper, type ThemeProjectHomeActionOptions, type ThemeProjectHomeFeatureItem, type ThemeProjectHomeFeatureOptions, type ThemeProjectHomeHighlightItem, type ThemeProjectHomeHighlightOptions, type ThemeProjectHomePageFrontmatter, type ThemeReadingTimePluginHelper, type ThemeSEOPluginHelper, type ThemeSidebarArrayHelper, type ThemeSidebarHelper, type ThemeSidebarInfoOptions, type ThemeSidebarObjectHelper, type ThemeSitemapPluginHelper, type ThemeStatus, arraySidebar, blog, blogFilter, checkLegacyStyle, checkSocialMediaIcons, comment, config, convertFrontmatter, convertNavbarOptions, convertSidebarOptions, convertThemeOptions, copyCode, copyright, defaultPageSorter, defineHopeConfig, defineNavbarConfig, defineSidebarArrayConfig, defineSidebarConfig, defineSidebarObjectConfig, defineThemeConfig, extendsBundlerOptions, extendsPagePlugin, feed, getActiveHeaderLinksPlugin, getAlias, getAutoCatalogPlugin, getBlogArticleType, getBlogCategoryCategory, getBlogPlugin, getBlogStarType, getBlogTagCategory, getBlogTimelineType, getCommentPlugin, getComponentsPlugin, getCopyCodePlugin, getCopyrightPlugin, getEncryptConfig, getFeedPlugin, getMdEnhancePlugin, getPWAPlugin, getPhotoSwipePlugin, getPluginConfig, getRtlPlugin, getSEOPlugin, getSearchPlugin, getSidebarData, getSidebarSorter, getSitemapPlugin, getStatus, getStructureInfo, getThemeData, git, hopeTheme as hope, hopeTheme, injectBlogBasicInfo, injectPageInfo, mdEnhance, navbar, navbarConfig, objectSidebar, photoSwipe, prepareBundleConfigFile, prepareHighLighterScss, prepareSeparatedConfigFile, prepareSidebarData, prepareSocialMediaIcons, pwa, readingTime, removePrismPlugin, seo, sidebar, sidebarConfig, sidebarDateDescSorter, sidebarDateSorter, sidebarFilenameSorter, sidebarOrderSorter, sidebarReadmeSorter, sidebarTitleSorter, sitemap, themeConfig, themeLocalesData, useExtendsPagePlugin, usePlugin, usePrismPlugin };
